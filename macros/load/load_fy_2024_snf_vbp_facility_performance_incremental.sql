...
{% macro load_fy_2024_snf_vbp_facility_performance_incremental() %}
    ...
    {% for row in file_list_results %}
        ...
        {% if file_name.endswith('.csv') and 'FY_2024_SNF_VBP_Facility_Performance' in file_name %}
            ...
            {% if check_result.columns[0].values()[0] == 0 %}
                ...
                {% set copy_sql %}
                    COPY INTO HEALTHCARE.RAW.FY_2024_SNF_VBP_FACILITY_PERFORMANCE
                ...
                {% set insert_sql %}
                    ...
                    VALUES ('{{ file_name }}', CURRENT_TIMESTAMP, 'HEALTHCARE.RAW.FY_2024_SNF_VBP_FACILITY_PERFORMANCE');
                {% endset %}
